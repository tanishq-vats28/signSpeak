    ...
    <div className="container">
      <div className="row justify-content-between m-4">
        <div className="col-6 fs-5 mt-5 info-first-col">
          ...
          <p className="mt-2">
            <b>Chatbox Integration:</b> Deaf/mute users can communicate via a
            chatbox during video calls, making it easier to express their
            thoughts to hearing individuals.
          </p>
          <p className="mt-4">
